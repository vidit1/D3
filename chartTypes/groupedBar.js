  ...
  chart.plot = function () {
    ...
    rectangle
      .on('mousemove', function (d) {
        ...
        var xpos = parseInt(Math.max(0,(cord[0]-margin.left))/(x0.rangeBand()));
        ...
        nvtooltip.show(obj.divId,[x0(d.date) + margin.left + x0.rangeBand() / 2, cord[1]], obj.tooltip.formatter(tempData,legends));
      })
